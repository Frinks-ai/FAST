...
ctw_train_gt_dir = ctw_root_dir + 'train/trainval_label_curve/'
...
class FAST_CTW(data.Dataset):
    def __init__(self, split='train', is_transform=False, img_size=None, short_size=640,
        ...
        print("train data dirs :", ctw_train_data_dir, ctw_train_gt_dir, split)       
        if split == 'train':
        ...
        self.img_paths = []
        self.gt_paths = []
        print("The train dir: ", data_dirs)
        print("The GT dirs: ", gt_dirs)
        # exit()
        ...
        for data_dir, gt_dir in zip(data_dirs, gt_dirs):
            ...
            for idx, img_name in enumerate(img_names):
                ...
                print("Gt dire path: ", gt_dir, "GT file name :", gt_name)
